...
ANALYSIS_ADAPTIVE_DEPTH = env.bool('ANALYSIS_ADAPTIVE_DEPTH', default=True)
ANALYSIS_REVIEW_MIN_DEPTH = env.int('ANALYSIS_REVIEW_MIN_DEPTH', default=12)
ANALYSIS_REVIEW_MAX_DEPTH_BOOST = env.int('ANALYSIS_REVIEW_MAX_DEPTH_BOOST', default=3)
ANALYSIS_ADAPTIVE_DEPTH_REMOTE = env.bool('ANALYSIS_ADAPTIVE_DEPTH_REMOTE', default=False)
ANALYSIS_REVIEW_REMOTE_MAX_DEPTH = env.int('ANALYSIS_REVIEW_REMOTE_MAX_DEPTH', default=14)
ANALYSIS_REVIEW_REMOTE_LONGGAME_DEPTH = env.int('ANALYSIS_REVIEW_REMOTE_LONGGAME_DEPTH', default=12)
ANALYSIS_REVIEW_REMOTE_MULTIPV = env.int('ANALYSIS_REVIEW_REMOTE_MULTIPV', default=1)
ANALYSIS_STRICT_ENGINE_VERSION_CACHE = env.bool('ANALYSIS_STRICT_ENGINE_VERSION_CACHE', default=False)
